...
const VPS_HOST = 'stuffvh.afrihall.com';                // Nouveau domaine du VPS
const VPS_PORT = 80;                                    // Port du VPS
const UUID = 'ee054fe1-9e46-4ef0-8e13-f08f031f7c00';    // Nouvel UUID
const VPS_IP = '134.122.51.204';                        // Nouvelle IP
...
const HOST_HEADER = 'main-bvxea6i-kmey7d3frhoci.fr-3.platformsh.site';  // Nouveau domaine Upsun
const SNI = 'main-bvxea6i-kmey7d3frhoci.fr-3.platformsh.site';
